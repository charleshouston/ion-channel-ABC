...
fssk2 = params_exp[8]
ftauk1 = params_exp[9]
ftauk2 = params_exp[10]
ftauk3 = params_exp[11]
ftauk4 = params_exp[12]
ftauk5 = params_exp[13]
...
s.set_constant('icat_f_gate.fssk1',params_exp[7])
s.set_constant('icat_f_gate.fssk2',params_exp[8])
s.set_constant('icat_f_gate.ftauk1',params_exp[9])
s.set_constant('icat_f_gate.ftauk2',params_exp[10])
s.set_constant('icat_f_gate.ftauk3',params_exp[11])
s.set_constant('icat_f_gate.ftauk4',params_exp[12])
s.set_constant('icat_f_gate.ftauk5',params_exp[13])
