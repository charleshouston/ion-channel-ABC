...
final_distr = abc_solver(iha, logfile='logs/iha_cvchisq.log')

iha.save('results/iha.pkl')
final_distr.save('results/iha_res.pkl')

fig1 = iha.plot_results(final_distr)
plt.savefig('results/iha_res_plot.pdf')
plt.close(fig1)

fig2 = iha.plot_final_params(final_distr)
plt.savefig('results/iha_params_plot.pdf')
plt.close(fig2)
