...
"""
NB : Na_o in the nygren_Na.mmt file corresponds to Na_o in the Sakakibara paper according to equation (3) in Sakakibara paper.
"""
...
#######################################################################################################################
### IV curve : potential reversal as function of Na_o - Sakakibara 1992
...
# DATA
Na_o, rever, sd_rever = dataSaka.Reversal_potential_Sakakibara()
...
sakakibara_rever_dataset = np.asarray([Na_o, rever, variances_rever])
...
for Na_o in [2000,5000,10000,20000]:
    sakakibara_conditions = {'membrane.Na_o': Na_o,
                            'membrane.Na_i': 5000,
                            'membrane.T': 290.15}
