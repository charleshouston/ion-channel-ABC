...
dias_iv_description = """
    IV curve from Dias et al, 2014.
    """

dias2014_iv = Experiment(dataset=[vsteps, peaks, variances],
...
nakajima_desc = """
    Availability (inactivation) curve from Nakajima et al.
    """
...
zhang_desc = """
    Recovery curve from Zhang et al.
    """

zhang_recovery = Experiment(
    dataset=[tsteps_rec, rec, [0.]*len(tsteps_rec)],
